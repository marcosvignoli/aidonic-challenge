...
import { TextRN } from '@aidonic/ui/react-native';
      ...
      <View style={[styles.infoCard, { backgroundColor: '#FFFFFF' }]}>
        ...
        <View style={styles.infoGrid}>
          <View style={styles.infoItem}>
            <Text style={[styles.infoLabel, { color: '#666666' }]}>Region</Text>
          ...
          <View style={styles.infoItem}>
            <Text style={[styles.infoLabel, { color: '#666666' }]}>Status</Text>
            <View
              style={[
                styles.statusBadge,
                {
      ...
      <View style={[styles.beneficiaryCard, { backgroundColor: '#FFFFFF' }]}>
        ...
        distribution.beneficiaryList.length > 0 ? (
            ...
            {distribution.beneficiaryList.map((beneficiary: any) => (
              ...
              >
                <View style={styles.beneficiaryAvatar}>
                  <Text
                    style={[styles.beneficiaryInitial, { color: '#000000' }]}
                  >
          ...
          <View style={styles.emptyBeneficiaryContainer}>
            ...
            <Text style={[styles.emptyBeneficiaryTitle, { color: '#000000' }]}>
